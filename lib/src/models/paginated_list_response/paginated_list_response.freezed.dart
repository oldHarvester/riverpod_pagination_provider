...
mixin _$PaginatedListResponse<T> {
  ...
  $PaginatedListResponseCopyWith<T, PaginatedListResponse<T>> get copyWith =>
      _$PaginatedListResponseCopyWithImpl<T, PaginatedListResponse<T>>(
          this as PaginatedListResponse<T>, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PaginatedListResponse<T> &&
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(results), totalCount);
...
abstract mixin class $PaginatedListResponseCopyWith<T, $Res> {
  factory $PaginatedListResponseCopyWith(PaginatedListResponse<T> value,
          $Res Function(PaginatedListResponse<T>) _then) =
...
class _PaginatedListResponse<T> extends PaginatedListResponse<T> {
  const _PaginatedListResponse(
      {required final List<T> results, required this.totalCount})
      : _results = results,
        super._();
